...
reported to the project maintainers by emailing **hawkeye.sterling.v2@gmail.com**
or via a private report to the repository owner on GitHub. All complaints will be
...
1. **Correction** — a private, written warning providing clarity about the
   violation and why the behavior was inappropriate.
2. **Warning** — consequences for continued behavior, with a request to stop.
